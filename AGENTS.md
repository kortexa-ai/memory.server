...
Use `ktxsvc` for managed service operations. The platform units in `launchd/`
and `systemd/` are implementation files; do not install or invoke them directly.
...
- [ ] Managed service setup through `ktxsvc`
- [ ] Tests
